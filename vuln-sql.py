...
class Engine(object):
    ...
    def start(self):
        self.display.banner()
        self.display.primary(f'Dork: {self.dork}')
...
def args():
    ...
    args.add_argument('-w', '--write-over', dest='writeover', default=False, action='store_true',
                      help='write over the existing log file')
